...
<div class="container-fluid">
    ...
    <div class="row" style="margin:0 20vw;">
        <div class="bg-light rounded-3 p-5">
            <h2>Privacy Policy for CroHerze</h2>
            <p>At CroHerze YouTube Converter, accessible from <a class="text-dark" href="https://convert.croherze.com/">https://convert.croherze.com/</a>,
                one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types
                of information that is collected and recorded by CroHerze YouTube Converter and how we use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in CroHerze YouTube Converter. This policy is
                not applicable to any information collected offline or via channels other than this website. Our Privacy
                Policy was created with the help of the Privacy Policy Generator.</p>
            <h3>Consent</h3>
            ...
            <h3>Log Files</h3>
            <p>CroHerze YouTube Converter follows a standard procedure of using log files. These files log visitors when
            ...
            <p>Like any other website, CroHerze YouTube Converter uses 'cookies'. These cookies are used to store
            ...
            <ul>
                <li>
                    <div>Google</div>
                    <div>https://policies.google.com/technologies/ads</div>
                </li>
            </ul>
            <h3>Advertising Partners Privacy Policies</h3>
            <p>You may consult this list to find the Privacy Policy for each of the advertising partners of CroHerze
                YouTube Converter.</p>
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on CroHerze YouTube Converter, which are
            ...
            <p>Note that CroHerze YouTube Converter has no access to or control over these cookies that are used by
                third-party advertisers.</p>
            <h3>Third Party Privacy Policies</h3>
            <p>CroHerze YouTube Converter's Privacy Policy does not apply to other advertisers or websites. Thus, we are
            ...
            <p>CroHerze YouTube Converter does not knowingly collect any Personal Identifiable Information from children
