...
<body class="pb-5" style="background: url(https://croherze.com/forum/images/styles/DarkCore/style_orange/pageBG.png) repeat bottom left; margin:1vh 2vw; font-family: 'Open Sans', 'sans-serif','serif';">
<div class="container-fluid">
    <?php include 'includes/nav.php'; ?>
    <div class="row" style="margin:0 20vw;">
        <div class="bg-light rounded-3 p-5">
            <h2>Terms and Conditions</h2>
            <p>Welcome to CroHerze YouTube Converter!</p>
            <p>These terms and conditions outline the rules and regulations for the use of CroHerze's Website, located
                at <a class="text-dark" href="https://convert.croherze.com/">https://convert.croherze.com/</a>.</p>
            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                CroHerze YouTube Converter if you do not agree to take all the terms and conditions stated on this page.</p>
            <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice
                ...
                prevailing law of Croatia. Any use of the above terminology or other words in the singular, plural,
                capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to
                same.</p>
            <h3>Cookies</h3>
            <p>We employ the use of cookies. By accessing CroHerze YouTube Converter, you agreed to use cookies in
                agreement with the CroHerze's Privacy Policy.</p>
            ...
            <h3>License</h3>
            <p>Unless otherwise stated, CroHerze and/or its licensors own the intellectual property rights for all
                material on CroHerze YouTube Converter. All intellectual property rights are reserved. You may access
                this from CroHerze YouTube Converter for your own personal use subjected to restrictions set in these
                terms and conditions.
            <p>You must not:
            <ul>
                <li>Republish material from CroHerze YouTube Converter</li>
                <li>Sell, rent or sublicense material from CroHerze YouTube Converter</li>
                <li>Reproduce, duplicate or copy material from CroHerze YouTube Converter</li>
                <li>Redistribute content from CroHerze YouTube Converter</li>
            </ul>
            ...
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. CroHerze does not filter, edit, publish or review Comments prior to their
                presence on the website. Comments do not reflect the views and opinions of CroHerze,its agents and/or
                affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To
                the extent permitted by applicable laws, CroHerze shall not be liable for the Comments or for any
            ...
            <p>CroHerze reserves the right to monitor all Comments and to remove any Comments which can be considered
            ...
            <p>You hereby grant CroHerze a non-exclusive license to use, reproduce, edit and authorize others to use,
            ...
            <ul>
                ...
                <li>(c) the benefit to us from the visibility of the hyperlink compensates the absence of CroHerze;
                    and </li>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to CroHerze. Please include your name, your
            ...
            <ul>
                ...
                <li>No use of CroHerze's logo or other artwork will be allowed for linking absent a trademark license
                    agreement.</li>
            </ul>
            <h3>iFrames</h3>
            ...
            <h3>Your Privacy</h3>
            <p>Please read <a class="text-dark" href="policy.php">Privacy Policy</a></p>
...
<footer class="bg-dark text-center text-sm-start fixed-bottom">
    <div class="text-center p-2" style="background-color: rgba(0, 0, 0, 0.2);">
        <a class="text-white" href="index.php">Go back to converter</a>
    </div>
</footer>
</body>
</html>